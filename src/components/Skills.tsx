...
const SkillCard = ({ icon, title, skills, color, delay }: { 
  ...
  return (
    <div 
      ref={cardRef}
      className={`cyber-card h-full transition-all duration-700 ${
...
const Skills = () => {
  ...
  const skillCategories = [
    ...
    {
      icon: <Terminal className="w-5 h-5 text-cyber-pink" />,
      title: 'Development',
      color: 'cyber-pink',
      skills: [
        { name: 'PHP', level: 75 },
    ...
    {
      icon: <Database className="w-5 h-5 text-cyber-yellow" />,
      title: 'Professional',
      color: 'cyber-yellow',
      skills: [
    ...
    >
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-3xl md:text-4xl font-bold cyber-heading mb-4">Technical & Professional Skills</h2>
        ...
        >
          <div className="cyber-card text-center bg-gradient-to-br from-cyber-blue/80 to-cyber-neon/60 border-2 border-white/10 shadow-xl">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <div className="bg-cyber-dark/70 border border-cyber-blue/30 rounded-lg p-4 text-center w-full md:w-auto">
              ...
              <div className="bg-cyber-dark/70 border border-cyber-neon/30 rounded-lg p-4 text-center w-full md:w-auto">
              ...
              <div className="bg-cyber-dark/70 border border-cyber-pink/30 rounded-lg p-4 text-center w-full md:w-auto">
